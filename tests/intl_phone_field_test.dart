...
import 'package:intl_phone_field_flutter/intl_phone_field.dart';
...
void main() {
  testWidgets('Test intl_phone_field_flutter setup with completeNumber',
  ...
  testWidgets(
      'Test intl_phone_field_flutter setup with Guernsey number: +441481960194',
      (WidgetTester tester) async {
    await tester.pumpWidget(TestWidget(
  ...
  testWidgets(
      'Test intl_phone_field_flutter setup with UK number: +447891244567',
      (WidgetTester tester) async {
    await tester.pumpWidget(TestWidget(
